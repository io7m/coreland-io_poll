...
struct install_item insthier[] = {
  ...
  {INST_COPY, "_io-notice.h", 0, ctxt_repos, 0, 0, 0644},
  {INST_COPY, "_io-notice.h", 0, ctxt_incdir, 0, 0, 0644},
  ...
  {INST_COPY, "io_poll_impl.h", 0, ctxt_incdir, 0, 0, 0644},
  ...
  {INST_COPY_EXEC, "io_poll-conf", 0, ctxt_bindir, 0, 0, 0755},
};
